    ...
    if (!post) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center">
                ...
                <Link href="/uit-today" className="text-primary-red hover:underline">
                    Back to UIT Today
                </Link>
            </div>
        );
        ...
        <div className="single-post-page">
                ...
                <div className="single-post__container">
                    <div className="single-post__heading text-center">
                        <nav className="breadcrumbs">
                            ...
                            <span className="separator text-small"> / </span>
                            <span className="breadcrumbs__link text-small">
                        ...
                        <div className="page-title">
                            <h1 className="text-blue">{post.title}</h1>
                        </div>
            ...
            <div className="single-post__wrap">
                <aside className="sidebar --fixed">
                    {/* Sticky Social Share (Static for now, can be made dynamic later) */}
                    <div className="addtoany_shortcode">
                        <div className="a2a_kit a2a_kit_size_56 addtoany_list" style={{ lineHeight: '56px' }}>
                            ...
                            <a className="a2a_button_twitter" href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(post.title)}&url=${encodeURIComponent(typeof window !== 'undefined' ? window.location.href : '')}`} target="_blank" rel="noopener noreferrer">
                ...
                <div className="container">
                    ...
                    <div className="single-post__content-wrap">
                        <article className="single-post__content">
                            ...
                            <div className="single-post__tags mt-8 border-t pt-4">
                                <p className="text-small text-grey">Category:</p>
                                <span className="single-post__tag inline-block bg-gray-100 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">
                                    {post.category}
                                </span>
                            </div>
                        </article>
