                                    ...
                                    <div className="accordion-section__head-text-wrap">
                                        ...
                                        <div className="grid gap-6 md:grid-cols-2">
                                            {[
                                                ...
                                                <div key={index} className="p-4 bg-white border border-gray-100 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                                ...
                                                <div className="grid md:grid-cols-2 gap-x-8 gap-y-3">
                                                    {section.items.map((item, itemIdx) => (
                                                        <a
                                                            ...
                                                            className={`flex items-start gap-3 group ${item.url === '#' ? 'cursor-default' : 'hover:translate-x-1 transition-transform'}`}
                                                        ...
                                                        >
                                                            ...
                                                            <span className={`${item.url === '#' ? 'text-gray-700' : 'text-[#002856] group-hover:text-[#ed1c24] transition-colors'}`}>
                                                                {item.title}
                                                            </span>
                                                        </a>
                                                    ))}
