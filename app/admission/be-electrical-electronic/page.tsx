...
export default function BEElecElectronicPage() {
    return (
        <div className="page-be-elec-electronic">
            <PageHero
                title="BE Electrical (Electronic)"
                subtitle="Powering the Electronic World"
                bgImage="https://uitu.edu.pk/wp-content/uploads/2024/01/ACA4-1024x682.jpeg"
                breadcrumbs={[
                    { label: 'Home', href: '/' },
                    { label: 'Admission', href: '/admission' },
                    { label: 'BE Electrical (Electronic)' }
                ]}
            >
                            ...
                            content: (
                                <div className="accordion-section__head">
                                    <div className="accordion-section__head-image">
                                        <img src="https://uitu.edu.pk/wp-content/uploads/2024/01/ACA4-1024x682.jpeg" alt="Overview" style={{ width: '100%', height: '480px', objectFit: 'cover' }} />
                                    </div>
                                    <div className="accordion-section__head-text -light-bg" style={{ marginTop: '-150px' }}>
                                        <div className="accordion-section__head-text-wrap">
                                            ...
                                            <div className="prose max-w-none text-gray-600">
                                                <p>This program provides a comprehensive education in the principles and practices of electronics, dealing with the design, development, testing, and maintenance of electronic equipment and systems. It prepares students for a wide range of careers, blending theoretical knowledge with practical skills to tackle real-world challenges in technology and innovation.</p>
                                                ...
                                                <ul className="list-disc pl-5 space-y-2">
                                                    ...
                                                    <li><strong>Total number of courses:</strong> 45 + Final Year Project</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
