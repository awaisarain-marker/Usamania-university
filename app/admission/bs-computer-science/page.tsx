...
import { semesterData, internshipData } from '@/app/admission/bs-computer-science/courseData';
import BlogSection from '@/components/home/BlogSection';
import EventsSection from '@/components/home/EventsSection';

export default function BSCSPage() {
    return (
        <div className="page-bscs">
            <PageHero
                            ...
                            content: (
                                <div className="accordion-section__head">
                                    <div className="accordion-section__head-image">
                                        <img src="https://uitu.edu.pk/wp-content/uploads/2024/08/cs-2048x1152.jpg" alt="Overview" style={{ width: '100%', height: '480px', objectFit: 'cover' }} />
                                    </div>
                                    <div className="accordion-section__head-text -light-bg" style={{ marginTop: '-150px' }}>
                                        <div className="accordion-section__head-text-wrap">
                                            ...
                                            <div className="prose max-w-none text-gray-600">
                                                <p>This 4-year program provides a comprehensive foundation in theoretical and algorithmic concepts, data structures, computer network design, information processing, and artificial intelligence. It emphasizes both the mathematical and engineering aspects of computing, preparing students for diverse roles in the tech industry.</p>
                                                ...
                                                <ul className="list-disc pl-5 space-y-2">
                                                    ...
                                                    <li><strong>Total number of courses:</strong> 45 (Including Final Year Project)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            content: (
                                <div className="w-full pt-8">
                                    ...
                                    <div className="prose max-w-none text-gray-600">
                                        ...
                                        <p>The graduates of the BS Computer Science program will have the knowledge, understanding and skills to:</p>
                                        <ul className="list-disc pl-5 mb-8 space-y-2">
                                            <li>Pursue diverse range of careers, advanced degrees, or professional development in various computing disciplines.</li>
                                            <li>Apply analytical skills, computing principles, and modern technologies to design innovative and sustainable computing solutions to meet business objectives and societal challenges.</li>
                                        ...
                                        <p>The students of BS Computer Science program are expected to attain the following outcomes by the time of graduation:</p>
                                        <ul className="list-disc pl-5 space-y-2">
