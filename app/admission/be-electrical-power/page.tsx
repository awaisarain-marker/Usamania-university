...
export default function BEElecPowerPage() {
    return (
        <div className="page-be-elec-power">
            <PageHero
                title="BE Electrical (Power)"
                subtitle="Energizing the Future"
                bgImage="https://uitu.edu.pk/wp-content/uploads/2023/12/PE-Feild-trip2.jpg"
                breadcrumbs={[
                    { label: 'Home', href: '/' },
                    { label: 'Admission', href: '/admission' },
                    { label: 'BE Electrical (Power)' }
                ]}
            >
                            ...
                            content: (
                                <div className="accordion-section__head">
                                    <div className="accordion-section__head-image">
                                        <img src="https://uitu.edu.pk/wp-content/uploads/2023/12/PE-Feild-trip2.jpg" alt="Overview" style={{ width: '100%', height: '480px', objectFit: 'cover' }} />
                                    </div>
                                    <div className="accordion-section__head-text -light-bg" style={{ marginTop: '-150px' }}>
                                        <div className="accordion-section__head-text-wrap">
                                            ...
                                            <div className="prose max-w-none text-gray-600">
                                                <p>This program prepares students for a dynamic field focused on the generation, transmission, distribution, utilization and management of electrical power. It provides a strong foundation in both theoretical and practical aspects, enabling graduates to pursue diverse career opportunities and contribute to the advancement of future energy systems and technologies.</p>
