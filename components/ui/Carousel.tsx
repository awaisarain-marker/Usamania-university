...
export default function Carousel({ items, sectionTitle }: CarouselProps) {
    const [lightboxImage, setLightboxImage] = useState<string | null>(null);
    const [mounted, setMounted] = useState(false);
    const id = useId();
    const uniqueId = id.replace(/:/g, ''); // Sanitize for CSS selector usage
        ...
        <div className="images-slider__wrap group relative w-full py-8">
            <style jsx global>{`
                ...
                .images-slider__image {
                    ...
                    cursor: pointer;
                    position: relative;
                    /* Ensure border stays visible - overflow hidden on inner part if needed? */
                    /* The red border is on this container. The image scales inside. */
                ...
                .swiper-slide {
                    ...
                    padding-left: 1px; /* fix for potential border clipping */
                }
                .swiper-slide img {
                    width: 100%;
                    height: 100%;
            ...
            <div className="images-slider__nav">
                {sectionTitle && (
                    <h3 className="images-slider__nav-title">{sectionTitle}</h3>
                )}
                        ...
                        >
                            <div className="relative w-full h-full overflow-hidden">
                                <img
                                    ...
                                    className="transition-transform duration-500 group-hover/item:scale-105 w-full h-full object-cover"
                                />
                                {item.title && (
            ...
            {/* Lightbox - Uses Portal to break stacking context */}
                    ...
                    {lightboxImage && (
                        ...
                        >
                            ...
                            <motion.img
                                ...
                                src={lightboxImage}
                                alt="Full size"
                                className="max-w-full max-h-[90vh] object-contain shadow-2xl relative z-[99999]"
