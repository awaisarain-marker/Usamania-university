...
export default function StickyNav() {
    ...
    const [activeSection, setActiveSection] = useState<string>('mous');
    ...
    const navItems = [
        ...
        { id: 'alumni-engagement', label: 'Alumni Engagement' },
        { id: 'corporate-liaison-events', label: 'Corporate Liaison Events' },
        { id: 'corporate-social-responsibility', label: 'Corporate Social Responsibility' },
        { id: 'day-trip-learning', label: 'Day Trip Learning' }
    ];
