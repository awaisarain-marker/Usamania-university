...
const testimonials = [
    ...
    },
    {
        ...
        fullText: "One of my favorite moments at AUBG was during the fall semester of my senior year. I had the opportunity to take a trip to Brussels as part of a European Studies class. I was standing waiting for the metro talking to some friends from Ukraine and Bulgaria. In that moment I realized how surreal my whole experience at AUBG has been. I am an American who has been lucky enough to live on another continent for four years and meet people from all over the world.",
    ...
    },
    {
        ...
        quote: "AUBG helped grow my horizons by offering a diverse community and wonderfully passionate professors.",
        fullText: "\"AUBG helped grow my horizons by offering a diverse community, wonderfully passionate professors, and areas to practice the academic material and skills learned on campus.\"",
    ...
    },
    {
        ...
        location: "Sophomore at AUBG | Originally from New York City",
    ...
    },
    {
        ...
        quote: "I see the diversity of both the faculty and the student body as AUBG's main advantage.",
        fullText: "I see the diversity of both the faculty and the student body as AUBG's main advantage; that was one of the top reasons I came here in the first place.",
